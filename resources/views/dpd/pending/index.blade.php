        ...
        $(document).ready(function () {
            ...
            $('#anggota tbody').on('click', '.cb-child', function () {
                if ($(this).prop('checked') != true) {
                    $("#pending-select-all").prop('checked', false)
                }
    ...
    <script>
        ...
        function akftifstatus() {
            ...
            $.ajax({
                url: "{{route ('dpd.pending.updateaktif')}}",
                method: 'post',
                data: {
                    ids: semua_id,
        ...
        function nonaktif() {
            ...
            $.ajax({
                url: "{{route ('dpd.pending.updatenonaktif')}}",
                method: 'post',
                data: {
                    ids: semua_id,
