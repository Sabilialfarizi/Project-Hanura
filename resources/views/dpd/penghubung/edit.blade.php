...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ "/dpd/penghubung/$penghubung->id" }}" method="post"
                        ...
                        <tbody>
                             ...
                             <tr>
                                ...
                                <th>
                                    ...
                                    <input type="hidden" name="provinsi" class="form-control"  value="{{$penghubung->provinsi_domisili}}"
                                    @if($errors->has('no_sk'))
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpd/wheres/kepengurusan/loaddata/{{$provinsi->id_prov}}`,
    ...
    $(document).ready(function () {
        $('.dynamic').change(function () {
            ...
            $.ajax({
                url: `/dpd/wheres/kepengurusan/searchAnggota`,
                method: "get",
                data: {
                    'id': id
                },
