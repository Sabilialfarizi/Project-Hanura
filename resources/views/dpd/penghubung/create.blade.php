...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ "/dpd/penghubung" }}" method="post"
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <textarea type="text" name="alamat" class="form-control" id="alamat" rows="3"
                                     ...
                                     <!--<input type="hidden" name="kabupaten_domisili" class="form-control" id="kabupaten_domisili">-->
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpd/wheress/kepengurusan/loaddata/{{$provinsi->id_prov}}`,
    ...
    $(document).ready(function () {
        $('.dynamic').change(function () {
            ...
            $.ajax({
                url: `/dpd/wheress/kepengurusan/searchAnggota`,
                method: "get",
                data: {
                    'id': id
                },
