...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-material mt-4" action="{{ route('dpd.member.update', $member->id) }}" method="POST"
            ...
            <blockquote>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('status_pendidikan') ? 'has-error' : '' }}">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sg-6 m-b-6">
                        <div class="form-group {{ $errors->has('pakta_intergritas') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <label style="font-size:12px; " for="password"> <i
                                    class="fa-solid fa-triangle-exclamation"></i> Maksimum 2mb, format pdf/doc</label>
                        </div>
                    </div>
