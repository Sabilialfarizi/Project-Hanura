            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 border-right" style="min-height: 100vh">
                        <h4 class="font-weight-bold mb-5" >Informasi</h4>
                        <h4 class="font-weight-bold" style="color:#C0792A;">{{ $info->name }}</h4>
                        <div class="d-flex mb-5">
                            <span class="badge badge-pill badge-danger mr-2">{{ $info->created_at ?? '' }}</span>
