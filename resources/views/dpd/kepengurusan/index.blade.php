...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a  style="background-color:#D6A62C; color:#FFFF;" class="btn float-right btn-lg" href="{{ '/dpd/kabupaten/'. $kabupaten->id_kab .'/kepengurusan/create' }}">
...
<div class="card">
    <div class="card-header">
        List Kepengurusan DPC Kabupaten/Kota {{ $kabupaten->name }}
    </div>
    ...
    $(document).ready(function () {
        ...
        function load_data(from = '', to = '') {
            ...
            var table = $('#anggota').DataTable({
                ...
                ajax: {
                    url: '/dpd/ajax/ajax_kepengurusan_kabupaten',
                    get: 'get',
                    data: {
                        from: from,
                        to: to,
                        id_daerah: {{ $kabupaten->id_kab }},
                    }
                },
