...
<div class="card">
    <div class="card-header">
        <strong>Form Kepengurusan DPC  {{ $kabupaten->name }}</strong>
    </div>

    <div class="card-body">
        <form action="{{ "/dpd/kabupaten/$kabupaten->id_kab/kepengurusan" }}" method="post"
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>Cari Anggota (Masukkan Nik)</th>
                                <th>:</th>
                                <th>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <textarea type="text" name="alamat_kantor" class="form-control" id="alamat" rows="3"
                                        >{{ $kepengurusan->alamat_kantor ?? '' }}</textarea>
                ...
                <div class="col-lg-3 col-12 d-flex justify-content-center mb-lg-0 mb-3">
                    <div class="file-input text-center">
                        ...
                        <label for="foto">
                            Upload Foto Pengurus (Wajib Untuk KSB)
                ...
                <div class="col-lg-3 col-12 d-flex justify-content-center">
                    <div class="file-input text-center">
                        ...
                        <label for="ttd">
                            Upload TTD Pengurus (Wajib Untuk KSB)
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpd/where/kepengurusan/loaddata/{{$kabupaten->id_kab}}`,
    ...
    $(document).ready(function () {
        $('.dynamic').change(function () {
            ...
            $.ajax({
                url: `/dpd/where/kepengurusan/searchAnggota`,
                method: "get",
                data: {
                    'id': id
                },
