...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-material mt-4" action="{{ route('dpd.listuser.update', $member->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" maxlength="14" id="nik" name="nik" class="form-control"
            ...
            <blockquote>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!--                <option {{ $data == $member->kabupaten_domisili ? 'selected' : '' }} value="{{ $data }}" name="{{ $row }}">{{ $row }}</option>-->
                        <!--                @endforeach-->
                        <!--            </select>-->
