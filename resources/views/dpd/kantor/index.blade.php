...
<div class="row">
    <div class="col-12">
        <h4 class="page-title">Kantor DPC Kabupaten/Kota {{ $daerah->name }}</h4>
    </div>
</div>
<style>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="report table table-bordered table-striped table-hover" id="provinsi"
                        width="100%">
                        <thead>
                            <tr style="font-size:12px;">
                                ...
                                <th>Domisili</th>
                                <th>Surat Keterangan Status Kantor</th>
                                <th>Rekening Bank</th>
                        ...
                        <tbody>
                            ...
                            <tr style="font-size:12px;">
                                ...
                                <td>
                                    ...
                                    href="{{asset('/uploads/file/no_sk/'.$kantor->no_sk)}}">Download SK.
                                        Kepengurusan</a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm" style="font-size:12px; background-color:#D6A62C; color:#FFFF;"
                                        ...
                                        Domisili</a>
                                    @else
                                    <a style="font-size:12px;">Belum Upload Domisili</a>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a class="btn btn-sm" style="font-size:12px; background-color:#D6A62C; color:#FFFF;"
                                       href="{{asset('/uploads/file/surat_keterangan_kantor/'.$kantor->surat_keterangan_kantor)}}">Download
                                        Surat
                                        Keterangan Status Kantor</a>
                                    @else
                                    <a style="font-size:12px;">Belum Upload Surat Keterangan Status Kantor</a>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    <a class="btn btn-sm" style="font-size:12px; background-color:#D6A62C; color:#FFFF;"
                                        ...
                                        Rekening Bank</a>
                                    @else
                                    <a style="font-size:12px;">Belum Upload Rekening Bank</a>
                                    @endif
                                </td>
                                <td>{{ $kantor->nomor_rekening_bank ?? '-'}}</td>
                                <td>
                                    @php
                                    $nama_bank= \App\Bank::getbank($kantor->nama_bank);
                                    @endphp
                                ...
                                <td>
                                    ...
                                    @else
                                    <a style="font-size:12px;">Belum Upload Cap Kantor</a>
                                    @endif
                                </td>
                                <td>{{ $kantor->target_dpc  ?? '0'}}</td>
                                <td>
                                    @if($kantor->status_kantor == 1)
                                    <a>Milik Sendiri</a>
                                    @elseif($kantor->status_kantor == 2)
                                    <a>Sewa, Hingga
                                        {{ Carbon\carbon::parse($kantor->tgl_selesai)->Format('d-m-Y') ?? '' }}</a>
                                    @else
                                    <a>Pinjam Pakai, Hingga
                                        {{ Carbon\carbon::parse($kantor->tgl_selesai)->Format('d-m-Y') ?? '' }}</a>
                                    @endif
                                ...
                                <td>
                                    <a style="background-color:#D6A62C; color:#FFFF;"
                                        href="{{ "/dpd/kabupaten/$daerah->id_kab/kantor/$kantor->id_kantor/edit" }}"
                                        class="btn btn-sm">Edit</a>
                                </td>
                            </tr>
                            @else
                            <tr>
                                <td colspan="22" class="text-center">Belum Ada Data</td>
                                <td>
                                    <a style="background-color:#D6A62C; color:#FFFF;"
                                        href="{{ route('dpd.kantor.create', $daerah->id_kab) }}"
                                        class="btn btn-sm">Tambah</a>
                                </td>
                            </tr>
                            @endif
                        </tbody>
