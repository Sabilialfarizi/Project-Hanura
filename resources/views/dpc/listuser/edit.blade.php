...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-material mt-4" action="{{ route('dpc.listuser.update', $member->id) }}" method="POST"
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-6 col-sg-6 m-b-6">
                        <div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
                            ...
                            <div class='click-zoom'>
                                <label>
                                    <input type='checkbox'>
                                    <img src="{{asset('uploads/img/users/'.$member->avatar)}}" alt='noimage' width='100px'
                                        height='100px'>
                                </label>
                            </div>
                    ...
                    <div class="col-sm-6 col-sg-6 m-b-6">
                        <div class="form-group {{ $errors->has('foto_ktp') ? 'has-error' : '' }}">
                            ...
                            <div class='click-zoom'>
                                <label>
                                    <input type='checkbox'>
                                    <img src="{{asset('uploads/img/foto_ktp/'.$member->foto_ktp)}}" alt='noimage' width='150px'
                                        height='100px'>
                                </label>
                            </div>
                    ...
                    <!--            class="form-control" value="{{$member->pakta_intergritas ?? ''}}">-->
                    ...
                    <div class="col-sm-6 col-sg-6 m-b-6">
                        <div class="form-group {{ $errors->has('jabatan') ? 'has-error' : '' }}">
                            ...
                            <select name="jabatan" id="jabatan" class="form-control select2"
                                style="width: 100%; height:36px;">
                                <option value="">-- Pilih --</option>
                                @foreach($roles as $data => $row)
                                <option {{ $data == $detail->role_id ? 'selected' : '' }} value="{{ $data }}">
                                    {{ $row }}
                                </option>
                                @endforeach
                            </select>
