...
<div class="row">
    <div class="col-md-10">
      <h4 class="page-title">List User DPC : {{$detail->name}}</h4>
    </div>
    
  

    <div class="col-sm-3 text-left m-b-20">
...
<div style="margin-bottom: 10px;" class="row">
    ...
    <div class="col-lg-6">
      ...
      Tingkatan :  <b>User DPC</b> : Dapat Login ke web. <b>User PAC</b> Dapat Login ke android
       </div>
    </div>
    ...
    <div class="col-lg-6">
        <a style="background-color:#D6A62C; color:#FFFF;" class="btn float-right btn-lg "
            href="{{ route('dpc.listuser.create') }}">
