...
<div class="row">
    <div class="col-md-6">
      <h4 class="page-title">Kecamatan DPC :  @php
        $name = \App\Kabupaten::getKab($DetailUsers->kabupaten_domisili);
        @endphp
   ...
   <div class="col-lg-6">
        ...
        DPC Dapat mengisi data <b>kantor / kepengurusan</b> PAC Disetiap kecamatan.
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        if(exist){
            alert(msg);
            window.location.href = '{{route('dpc.exports.index')}}';
        }
    });
