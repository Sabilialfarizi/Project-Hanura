...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a style="background-color:#D6A62C; color:#FFFF;" class="btn float-right" href="{{ route('dpc.pembatalan.create') }}">
            ...
            <table class="report table table-bordered table-striped table-hover datatable" id="pembatalan" width="100%">
             ...
             <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12 col-md-12 col-xl-12">
                        ...
                        <button type="submit" onclick="receivedstatus()" style="background-color:#D6A62C; color:#FFFF; margin-top:10px; margin-left:10px;" id="button_nonaktif" disabled class="btn float-left">
                           Menolak Pembatalan
                        </button>
                     <button type="submit" onclick="failstatus()" style="background-color:#D6A62C; color:#FFFF;  margin-top:10px; margin-left:10px;" id="button_aktif" disabled class="btn float-left">
                           Menerima Pembatalan
                        </button>
...
<script>
  function receivedstatus() {
            ...
            $.ajax({
                url:"{{route ('dpc.pembatalan.updateacc')}}",
                method:'post',
                data:{ids:semua_id},
     ...
     function failstatus() {
            ...
            $.ajax({
                url:"{{route ('dpc.pembatalan.updatefail')}}",
                method:'post',
                data:{ids:semua_id},
                success:function(res){
