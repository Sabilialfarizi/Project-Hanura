        ...
        <div class="card">
            ...
            <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <input type="text" required="" value="{{$pending->key ?? '-'}}"
                                            id="key" maxlength="12" class="form-control" readonly>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <input type="text" required="" id="tgl_lahir"
                                            value="{{Carbon\Carbon::parse($pending->tgl_lahir)->format('d/m/Y')}}" class="form-control" readonly>
                                    </th>
                                </tr>
                                <tr>
                                    <th>Jenis Kelamin</th>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        @php
                                        $nama_agama= \App\Agama::getAgama($pending->agama);
                                        @endphp
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <select name="form_select" id="test" class="form-control"
                                            ...
                                            <option value="2">Ditolak (Diperbaiki)</option>
                                        </select>
                ...
                <div id="hidden_div" style="display:none;">
                    <form class="form-material mt-4" action="{{ route('dpc.pending.update', $pending->userid) }}"
                        method="POST">
                        @csrf
                        @method('put')
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn"  style="background-color:#D6A62C; color:#FFFF;">{{ __('Simpan') }}</button>
                        </div>
                ...
                <div id="hidden_div2" style="display:none;">
                    <form class="form-material mt-4" action="{{ route('dpc.pending.store') }}" method="POST">
                        @csrf

                        <div class="form-group {{ $errors->has('id_anggota') ? 'has-error' : '' }}">
                            <input type="hidden" id="id_anggota" value="{{$pending->userid}}" name="id_anggota" required=""
                                class="form-control">
                        ...
                        <label for="alasan_pembatalan">Alasan Penolakan <span style="color: red">* (Wajib
                                    diisi)</span></label>
                        <textarea rows="5" class="form-control" value="" name="alasan_pembatalan" required
                            id="alasan_pembatalan" placeholder="Alasan Penolakan" required="Alasan Pembatalan Tidak Boleh Kosong"></textarea>
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpc/where/pembatalan/loaddata`,
