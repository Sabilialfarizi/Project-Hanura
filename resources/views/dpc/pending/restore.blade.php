...
<style>
    ...
    <div class="card-body">
        ...
        <form class="form-material mt-4" action="{{ route('dpc.pending.restore', $member->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('no_hp') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" maxlength="14" id="no_hp" name="no_hp"
                ...
                <div class="row">
                    <div class="col-sm-6 col-sg-6 m-b-6">
                        <div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
                            ...
                            <input type="file" accept="image/png, image/jpg, image/jpeg" id="avatar" name="avatar"
                    ...
                    <div class="col-sm-6 col-sg-6 m-b-6">
                        <div class="form-group {{ $errors->has('foto_ktp') ? 'has-error' : '' }}">
                            ...
                            <div class='click-zoom'>
                                <label>
                                    <input type='checkbox'>
                                    <img src="{{asset('uploads/img/foto_ktp/'.$member->foto_ktp)}}" alt='noimage'
                                        width='150px' height='100px'>
                                </label>
                            </div>
                            <input type="hidden" name="foto_ktp_lama" value="{{ $member->foto_ktp ?? '' }}">
                            <input type="file" accept="image/png, image/jpg, image/jpeg" id="foto_ktp" name="foto_ktp"
                                class="form-control" value="">
                            @else
                            <input type="hidden" name="foto_ktp_lama" value="{{ $member->foto_ktp ?? '' }}">
                            <input type="file" accept="image/png, image/jpg, image/jpeg" id="foto_ktp" name="foto_ktp"
                            ...
                            <!--        <label for="pakta_intergritas">Pakta Intergritas <span-->
                            <!--                style="color: red">*</span></label>-->
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('provinsi') ? 'has-error' : '' }}">
                                    <input hidden type="text" id="provinsi" name="provinsi"
                                        value="{{ old('provinsi_domisili', $member->provinsi_domisili) }}" placeholder="Nomor HP"
                                        class="form-control">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('kabupaten') ? 'has-error' : '' }}">
                                    <input hidden type="text" id="kabupaten" name="kabupaten"
                                        value="{{ old('kabupaten_domisili', $member->kabupaten_domisili) }}" placeholder="Nomor HP"
                                        class="form-control">
