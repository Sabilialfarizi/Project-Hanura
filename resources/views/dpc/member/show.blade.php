...
<?php
    $fot_ktp = file_exists('/www/wwwroot/siap.partaihanura.or.id/uploads/img/foto_ktp/'.$detail->foto_ktp) && !empty($detail->foto_ktp)?
                '/www/wwwroot/siap.partaihanura.or.id/uploads/img/foto_ktp/'.$detail->foto_ktp : '/www/wwwroot/siap.partaihanura.or.id/uploads/img/foto_ktp/ektp.png';
    ...
    $avatar = $detail->avatar ==  'profile.png' ?  '/www/wwwroot/siap.partaihanura.or.id/uploads/img/users/'.$member->image : '/www/wwwroot/siap.partaihanura.or.id/uploads/img/users/'.$detail->avatar || !empty($member->image) ? '/www/wwwroot/siap.partaihanura.or.id/uploads/img/users/'.$member->image : '/www/wwwroot/siap.partaihanura.or.id/uploads/img/profile.png';
            ...
            <div class="card-body">
                <div class="mb-2">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <h2 style="font-size:15px; font-weight:bold;">Foto Untuk KTA</h2>
                            
                                <a href="#myModal" data-toggle="modal" data-gallery="example-gallery" class="col-sm-6"
                                    data-img-url="<?php echo $pic_avatar ?>">

                                    <img src="<?php echo $pic_avatar ?>"
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <input type="text" required="" value="{{$created_by ?? '-'}}" 
                                            class="form-control" readonly>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           @php
                                           $tgl1 = $member->created_at;
                                           $tgl2 = date('Y-m-d', strtotime('-1 days', strtotime($tgl1)));
                                           @endphp
                                             <input type="text" required="" value="{{Carbon\Carbon::parse($member->pengesahan)->format('d/m/Y')}}" 
                                            class="form-control" readonly>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" required="" id="tgl_pengesahan"
                                            value="{{Carbon\Carbon::parse($member->created_at)->format('d/m/Y')}}" class="form-control" readonly>
