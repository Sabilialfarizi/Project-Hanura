...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" style="color:#D6A62C; font-weight:bold;" aria-current="page"
            href="/dpc/member/coba">Belum Ditransfer</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" style="color:#D6A62C; font-weight:bold;" href="/dpc/member/sdh_transfer">Sudah
            Ditransfer</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" style="color:#D6A62C; font-weight:bold;" href="/dpc/member/tdk_memenuhi">Tidak Memenuhi
            Syarat</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" style="color:#D6A62C; font-weight:bold;" href="/dpc/member/hasil_perbaikan">Hasil
            Perbaikan</a>
    </li>
</ul>
<br>
<div class="row">
    <div class="col-md-12">
        <h4 class="page-title">Daftar Anggota DPC {{$status_belum->nama_status}} : {{$kabupaten->name}} </h4>
    </div>
...
<div class="card">
                    ...
                    <div class="col-lg-12 col-md-12 col-xl-12">
                        ...
                        <form method="GET" action="{{ route('dpc.kabupaten.sdh_transfer.showMember') }}" target="_blank">
                            <button type="button" id="ktaAnggota"
                                ...
                                class="btn float-left"><i class="fa-solid fa-print"></i> KTA dan KTP (Hasil Transfer) Hal:<a id="tableInfo1"></a></button>
                        </form>
    ...
    <script>
        $(document).ready(function () {
            ...
            // $('#kabupaten tbody').on( 'click', 'tr', function () {
