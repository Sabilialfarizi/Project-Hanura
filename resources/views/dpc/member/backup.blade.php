...
<div class="row">
    <div class="col-md-12">
        <h4 class="page-title">Daftar Anggota DPC : {{$kabupaten->name}} </h4>
    </div>
...
<div class="card">
    <div class="card-header">
        ...
        ->where('detail_users.kabupaten_domisili', $detail)
        ->where('detail_users.status_kta', 1)
        ->where('detail_users.status_tms', 1)
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-lg-3 col-xl-3">
                <div class="panel panel-{{$status_tidak_lolos->warna_status}}">
                    <div class="panel-heading" style="font-size:14px;">
                        <input type='hidden' value=" {{$status_tidak_lolos->nama_status}}" id="fil2" class='filter1'
        ...
        <div class="row">
            <div class="col-md-3 col-sm-4 col-lg-4 col-xl-4 m-b-4">
                <input readonly style="font-size:15px; font-weight:bold;  border-top-style: hidden;
                  border-right-style: hidden;
                  border-left-style: hidden;
                  border-bottom-style: groove;
                  background-color: #eee;  outline: none;" value="Daftar Anggota" class="form-control " id="fila">
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-sg-4 m-b-4">
                        <div class="alert alert-success alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                    aria-hidden="true">&times;</span></button>
                            <a>MOHON MAAF ANDA BELUM BISA TRANSFER DATA KE KPU</a>

                            <!--<div  style="margin-left:30px;"class="led-red"></div>-->
    ...
    <script>
        $(document).ready(function () {
            ...
            var dtable = $('#kabupaten').DataTable();
            ...
            $('.filter-button-tidak').on('click', function () {
                //clear global search values
                var fila = $("#fil2").val();
                document.getElementById('fila').value = fila;
                alert(fila);
            ...
            $('.filter-button-belum').on('click', function () {
                //clear global search values
                var fila = $("#fil").val();
                document.getElementById('fila').value = fila;
                alert(fila);
            ...
            $('.filter-button-transfer').on('click', function () {
                //clear global search values
                var fila = $("#fil3").val();
                document.getElementById('fila').value = fila;
                alert(fila);
            ...
            $(".dataTables_input").on('keyup change', function () {
