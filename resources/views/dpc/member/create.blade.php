...
<div class="card">
    <div class="card-header">
        ...
        <label> Form Pendaftaran Anggota DPC Kabupaten / Kota <span style="font-size:20px;">
                @php
        ...
        <div class="alert alert-secondary" role="alert">
            Setiap anggota yang diinput, akan masuk ke menu "Pengesahan Anggota"
        </div>
    </div>

    <div class="card-body">
        <form class="form form-vertical" method="post" id="registrationForm1" enctype="multipart/form-data">
            {{-- <form class="form-material mt-4" action="{{ route('dpc.member.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
                                    ...
                                    <input <input type="text" pattern="\d*" id="nik" maxlength="16" name="nik" class="form-control"
                                        placeholder="Nomor KTP" value="" onKeyUp="numericFilter(this)" onchange="check_nik(this)">
                                    <p id="demo"></p>
                                    @if($errors->has('nik'))
                                    <em class="invalid-feedback">
                                        {{ $errors->first('nik') }}
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('job') ? 'has-error' : '' }}">
                                    ...
                                    <select name="job" id="job" class="form-control selectpicker"
                                        style="width: 100%; height:36px;" data-live-search="true" required="required">
                                        <option value="">-- Pilih --</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('no_hp') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="no_hp" maxlength="14" name="no_hp" placeholder="Nomor HP"
                        ...
                        <div class="col-sm-4 col-sg-4 m-b-4">
                            <div class="form-group {{ $errors->has('kabupaten') ? 'has-error' : '' }}">
                                ...
                                <select hidden name="kabupaten" id="kabupaten" class="form-control select2"
                                    ...
                                    <option {{ $data == $detail->kabupaten_domisili ? 'selected' : '' }}
                                        value="{{ $data }}" name="{{ $row }}">{{ $row }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
                                    ...
                                    <div class="collapse" id="collapseExample" style="padding-top:30px;">
                                        <div class="card card-body col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <img src="https://siap.partaihanura.or.id/uploads/uploads1.jpeg"
                                                        width="50%">
                                                        <br>
                                                          <label style="font-size:12px; text-align:center;" for="password"> Foto Laki-Laki</label>
                                                </div>
                                                <div class="col-lg-6">
                                                    <img src="https://siap.partaihanura.or.id/uploads/uploads2.jpeg"
                                                        width="50%">
                                                         <br>
                                                          <label style="font-size:12px; text-align:center; " for="password"> Foto Perempuan</label>
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('foto_ktp') ? 'has-error' : '' }}">
                                    ...
                                    <input type="file" id="foto_ktp" accept="image/png, image/jpg, image/jpeg"
                                    ...
                                    <a class="btn btn-default" data-toggle="collapse" href="#collapseExample1"
                                        role="button" aria-expanded="false" aria-controls="collapseExample">
                                        CONTOH : FOTO KTP
                                    </a>

                                   <div class="collapse" id="collapseExample1" style="padding-top:30px;">
                                        <div class="card card-body col-lg-12">
                                            <img width="50%" src="https://siap.partaihanura.or.id/uploads/scanktp.jpeg">
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function (e) {
        ...
        $('#registrationForm1').on('submit', function (e) {
            e.preventDefault();
            // $(this).html('Sending..');
            var name = $("#name").val();
            var nik = $("#nik").val();
            ...
            // var size = parseFloat(image.files[0].size / (5024 * 5024)).toFixed(2); 
            // if(size > 10) {
            //   swal('Error', 'Silakan Pilih Ukuran Foto Untuk KTA Kurang Dari 10 MB');
            //     return false;
            //     }
            //  }
            if (ktp == '') {
            ...
            if (typeof (ktp_file.files) != "undefined") {
                var ukuran = parseFloat(ktp_file.files[0].size / (5024 * 5024)).toFixed(2);
                if (ukuran > 10) {
                    swal('Error', 'Silakan Pilih Ukuran Foto KTP Kurang Dari 10 MB');
                    return false;
                }
            }
