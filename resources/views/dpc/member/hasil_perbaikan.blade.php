...
<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link" style="color:#D6A62C; font-weight:bold; font-size:19px;" href="{{ url ('dpc/anggota/sdh_transfer')}}">Sudah
    ...
    <li class="nav-item">
        <a class="nav-link active" style="color:#D6A62C; font-weight:bold; font-size:19px;" aria-current="page"
...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-title">Daftar Anggota DPC {{$hasil_perbaikan->nama_status}} : {{$kabupaten->name}} </h4>
            </div>
        ...
        <!--                <input type='hidden' value='Belum Ditransfer' id="fil" class='filter2' data-column-index='12'>-->

        <!--                <a type="button" class="btn btn-outline-primary filter-button-belum">-->
        ...
        <!--            <div class="panel-heading" style="font-size:14px;">-->
        <!--                <input type='hidden' value='Sdh Ditransfer' id="fil1" class='filter' data-column-index='12'>-->
        <!--                <a type="button" class="btn btn-outline-primary filter-button">-->
        ...
        <!--            <div class="panel-heading" style="font-size:14px;">-->
        <!--                <input type='hidden'-->
        <!--                    value=" {{$status_tidak_lolos->nama_status}} &{{$hasil_perbaikan->nama_status}}" id="fil2"-->
        <!--                    class='filter1' data-column-index='12'>-->
        <!--                <a type="button" class="btn btn-outline-primary filter-button-tidak">-->
        ...
        <!--            <div class="panel-heading" style="font-size:14px;">-->
        <!--                <input type='hidden' value='{{$hasil_perbaikan->nama_status}}' id="fil3" class='filter3'-->
        <!--                    data-column-index='12'>-->
        <!--                <a type="button" class="btn btn-outline-primary filter-button-transfer">-->
