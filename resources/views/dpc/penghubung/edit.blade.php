...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ "/dpc/penghubung/$penghubung->id" }}" method="post"
                        ...
                        <tbody>
                             ...
                             <tr>
                                ...
                                <th>
                                    ...
                                    <input type="hidden" name="kabupaten" class="form-control" id="kabupaten" value="{{$penghubung->kabupaten_domisili}}"
                                    @if($errors->has('no_sk'))
                            ...
                            <tr>
                                ...
                                <th>:</th>
                                <th>
                                     <input type="text" readonly="" name="koordinator" class="form-control" id="koordinator" value="{{$penghubung->nik}}">
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpc/wheres/kepengurusan/loaddata/{{$kabupaten->id_kab}}`,
