                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <textarea type="text" name="alamat" class="form-control" id="alamat" rows="3"
                                     ...
                                     <input type="hidden" name="kabupaten_domisili" value="{{$kabupaten->id_kab}}" class="form-control">
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpc/wheres/penghubung/loaddata/{{$kabupaten->id_kab}}`,
    ...
    $(document).ready(function () {
        $('.dynamic').change(function () {
            ...
            console.log(id);
            $.ajax({
                url: `/dpc/wheres/penghubung/searchAnggota`,
                method: "get",
                data: {
                    'id': id
                },
