                    ...
                    <div class="col">
                        ...
                        <a href="#myModal" data-toggle="modal" data-gallery="example-gallery" class="col-sm-6"
                            ...
                            <img src="{{asset('/uploads/img/users/' .$detail->avatar  ) }}"
                                style="margin-left:-20px; width: 150px; height: 100px;" class="img-fluid image-control"
                                alt="shortcut">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="{{asset('/uploads/img/users/'.$detail->avatar)}}" style="width: 400px; height: 264px;" class="img-fluid image-control">
            </div>
...
<div id="myModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img src="{{asset('/uploads/img/foto_ktp/'.$detail->foto_ktp)}}" style="width: 400px; height: 264px;" class="img-fluid image-control">
            </div>
            <div class="modal-footer">
                <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
            </div>
