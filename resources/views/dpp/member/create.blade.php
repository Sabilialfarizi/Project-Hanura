            ...
            <div class="row">
                <div class="col-sm-4 col-sg-4 m-b-4">
                    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="Nama" value=""
                ...
                <div class="col-sm-4 col-sg-4 m-b-4">
                    <div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="nik" name="nik" class="form-control" placeholder="Nomor KTP" value=""
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sg-4 m-b-4">
                    <div class="form-group {{ $errors->has('pakta_intergritas') ? 'has-error' : '' }}">
                        ...
                        <input type="file" id="pakta_intergritas" name="pakta_intergritas" class="form-control"
                            value="">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sg-4 m-b-4">
                    <div class="form-group {{ $errors->has('rt_rw') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="rt_rw" name="rt_rw" class="form-control" placeholder="RT dan RW">
                        @if($errors->has('rt_rw'))
                        <em class="invalid-feedback">
                            {{ $errors->first('rt_rw') }}
                        </em>
            ...
            <div class="col-sm-4 col-sg-4 m-b-4">
                <div class="form-group {{ $errors->has('provinsi') ? 'has-error' : '' }}">
                    ...
                    <select hidden name="provinsi" id="provinsi" class="form-control select2"
                        ...
                        <option {{ $data == $detail->provinsi_domisili ? 'selected' : '' }} value="{{ $data }}"
                            name="{{ $row }}">{{ $row }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-sm-4 col-sg-4 m-b-4">
                <div class="form-group {{ $errors->has('kabupaten') ? 'has-error' : '' }}">
                    ...
                    <select hidden name="kabupaten" id="kabupaten" class="form-control select2"
                        ...
                        <option {{ $data == $detail->kabupaten_domisili ? 'selected' : '' }} value="{{ $data }}"
                            name="{{ $row }}">{{ $row }}</option>
                        @endforeach
                    </select>
