...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <strong>Form Edit Kelurahan / Desa </strong>
        </div>

        <div class="card-body">
            <form action="{{ "/dpp/kecamatan/$kecamatan->id_kec/kelurahan/$kelurahan->id_kel" }}" method="post">
                @csrf
                @method('patch')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="id_kec" class="form-control" id="id_kec" value={{ $kecamatan->id_kec }} required readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="id_kel" class="form-control" id="id_kel" value={{ $kelurahan->id_kel }} required data-fixedValue="{{ $kecamatan->id_kec }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" id="name" value="{{ $kelurahan->name }}" required>
                                @if($errors->has('name'))
                                <strong class="text-danger">
                                    {{ $errors->first('name') }}
                                </strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="id_kpu" class="form-control" placeholder="Kode KPU" id="id_kpu" value="{{ $kelurahan->id_kpu }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="id_wilayah" id="id_wilayah" class="form-control select2" style="width: 100%; height:36px;" required>
                                    <option value="" selected hidden disabled>-- Pilih --</option>
                                    <option value="3" {{ $kelurahan->id_wilayah == 3 ? 'selected' : '' }}>Desa</option>
                                    <option value="4"{{ $kelurahan->id_wilayah == 4 ? 'selected' : '' }}>Kelurahan</option>
                                </select>
