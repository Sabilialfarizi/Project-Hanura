                ...
                <form class="form-material mt-4" action="{{ route('dpp.informasi.update', $informasi->id) }}"
                    ...
                    <div class="form-group {{ $errors->has('foto') ? 'has-error' : '' }}">
                        ...
                        <input type="file" id="foto" name="foto" class="form-control">
                           <input  type="hidden" id="foto_lama" name="foto_lama" value="{{$informasi->gambar ?? ''}}" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <textarea requried rows="10" class="form-control my-editor" name="content"
                           id="editor">{{ old('content', $informasi->content) }} </textarea>
