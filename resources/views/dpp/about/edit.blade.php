...
<div class="row justify-content-center">
    <div class="col-sm-6">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-material mt-4" action="{{ route('dpp.about.update', $settings->id) }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        <label for="about_us">About Us <span style="color: red">*</span></label>
                        <textarea  rows="10" class="form-control my-editor" name="about_us"
                    ...
                    <div class="form-group {{ $errors->has('pic_login') ? 'has-error' : '' }}">
                        <label for="pic_login">Foto Login<span style="color: red">*</span></label>
                          <input type="hidden" name="pic_login_lama" value="{{ $settings->pic_login ?? '' }}">
                        <input  type="file" id="pic_login" name="pic_login" class="form-control" >
                    ...
                    <div class="form-group {{ $errors->has('pic_after_login') ? 'has-error' : '' }}">
                        <label for="pic_after_login">Foto After Login<span style="color: red">*</span></label>
                         <input type="hidden" name="pic_after_login_lama" value="{{ $settings->pic_after_login ?? '' }}">
                        <input  type="file" id="pic_after_login" name="pic_after_login" class="form-control">
                    ...
                    <div class="form-group {{ $errors->has('pic_tentang_kami') ? 'has-error' : '' }}">
                        <label for="pic_tentang_kami">Foto Tentang Kami<span style="color: red">*</span></label>
                         <input type="hidden" name="pic_tentang_kami_lama" value="{{ $settings->pic_tentang_kami ?? '' }}">
                        <input  type="file" id="pic_tentang_kami" name="pic_tentang_kami" class="form-control">
                    ...
                    <div class="form-group {{ $errors->has('pic_kta_depan') ? 'has-error' : '' }}">
                        <label for="pic_kta_depan">Foto KTA DEPAN<span style="color: red">*</span></label>
                         <input type="hidden" name="pic_kta_depan_lama" value="{{ $settings->pic_kta_depan ?? '' }}">
                        <input  type="file" id="pic_kta_depan" name="pic_kta_depan" class="form-control">
