...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
             <strong>Form Kepengurusan PAC Kecamatan {{ $kecamatan->name }}</strong>
        </div>

        <div class="card-body">
            <form action="{{ "/dpp/kecamatan/$kecamatan->id_kec/kepengurusan/$kepengurusan->id_kepengurusan" }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
