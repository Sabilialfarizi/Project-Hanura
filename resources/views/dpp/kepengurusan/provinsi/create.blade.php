...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ "/dpp/provinsi/$provinsi->id_prov/kepengurusan" }}" method="post"
...
<script>
    $(document).ready(function () {
        $(`.cari`).select2({
            ...
            ajax: {
                url: `/dpp/where/kepengurusan/loaddata/{{$provinsi->id_prov}}`,
    ...
    $(document).ready(function () {
        $('.dynamic').change(function () {
            ...
            $.ajax({
                url: `/dpp/where/kepengurusan/searchAnggota`,
                method: "get",
                data: {
                    'id': id
                },
