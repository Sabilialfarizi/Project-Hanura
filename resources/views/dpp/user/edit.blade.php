...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form class="form-material mt-4" action="{{ route('dpp.user.update', $member->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" maxlength="16" id="nik" name="nik" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('no_hp') ? 'has-error' : '' }}">
                                    ...
                                    <input maxlength="14" type="text" id="no_hp" name="no_hp"
            ...
            <blockquote>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <!--                <option {{ $data == $member->provinsi_domisili ? 'selected' : '' }}-->
                        ...
                        <!--             <label for="provinsi">Kabupaten / Kota <span style="color: red">*</span></label>-->
                        <!--            <select name="kabupaten" id="kabupaten" class="form-control select2"-->
                        <!--                style="width: 100%; height:36px;">-->
                        <!--                <option value="">-- Pilih --</option>-->
                        <!--                @foreach($kabupaten as $data => $row)-->
                        <!--                <option {{ $data == $member->kabupaten_domisili ? 'selected' : '' }}-->
                        <!--                    value="{{ $data }}" name="{{ $row }}">{{ $row }}</option>-->
                        <!--                @endforeach-->
                        <!--            </select>-->
                        ...
                        <!--                <option {{ $data == $member->kecamatan_domisili ? 'selected' : '' }}-->
                        <!--                    value="{{ $data }}" name="{{ $row }}">{{ $row }}</option>-->
                        <!--                @endforeach-->
                        <!--            </select>-->
                        ...
                        <!--                <option {{ $data == $member->kelurahan_domisili ? 'selected' : '' }}-->
                        <!--                    value="{{ $data }}" name="{{ $row }}">{{ $row }}</option>-->
                        <!--                @endforeach-->
                        <!--            </select>-->
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-sg-4 m-b-4">
                                <div class="form-group {{ $errors->has('kecamatan') ? 'has-error' : '' }}">
                                    ...
                                    <input name="kecamatan" id="kecamatan" type="hidden" class="form-control" value="{{$member->kecamatan_domisili ?? ''}}">
                                    @if($errors->has('kecamatan'))
                                    <em class="invalid-feedback">
                                        {{ $errors->first('kecamatan') }}
                                    </em>
                        ...
                        <div class="row">
                             <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('avatar') ? 'has-error' : '' }}">
                                    ...
                                    <strong style="font-size:12px;" class="text-danger">
                                        Silakan Pilih Ukuran Foto Untuk KTA Kurang Dari 2 MB
                                    </strong>
                                    <br>
                                    @endif
                                    @endif
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('jabatan') ? 'has-error' : '' }}">
                                    <label for="jabatan">Hak Akses <span style="color: red">*</span></label>
                                    <select name="jabatan" id="jabatan" class="form-control">
                                        <option value="">Pilih Hak Akses</option>
                                        <option {{$roles->role_id == 8 ? 'selected' : ''}} value="1">DPP</option>
                                        <option {{$roles->role_id == 4 ? 'selected' : ''}} value="2">DPC</option>
                                        <option {{$roles->role_id == 11 ? 'selected' : ''}} value="3">DPD</option>
                                        <option {{$roles->role_id == 5 ? 'selected' : ''}} value="4">PAC</option>
                                    </select>
                            ...
                            <!--        <input type="file" id="pakta_intergritas" accept=".pdf,.doc"-->
                            <!--            name="pakta_intergritas" class="form-control" value="">-->
