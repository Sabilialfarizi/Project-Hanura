...
<div class="card">
    <div class="card-header">
        ...
        <label> Form Pendaftaran User DPP </label>
    </div>

    <div class="card-body">
        <form class="form form-vertical" method="post" id="registrationForm" enctype="multipart/form-data">
            {{-- <form class="form-material mt-4" action="{{ route('dpp.user.store') }}" method="POST"
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('nik') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" id="nik" maxlength="16" name="nik" class="form-control"
                                        placeholder="Nomor KTP" value="" onKeyUp="numericFilter(this);">
                                    @if($errors->has('nik'))
                                    <em class="invalid-feedback">
                                        {{ $errors->first('nik') }}
                                    </em>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('no_hp') ? 'has-error' : '' }}">
                                    ...
                                    <input type="text" maxlength="14" id="no_hp" name="no_hp" placeholder="Nomor HP"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sg-6 m-b-6">
                                <div class="form-group {{ $errors->has('foto_ktp') ? 'has-error' : '' }}">
                                    ...
                                    <input type="file" id="foto_ktp"  accept="image/png, image/jpg, image/jpeg"  name="foto_ktp" class="form-control" value="">
                                    <label style="font-size:12px; " for="password"> <i
                                            class="fa-solid fa-triangle-exclamation"></i> Maksimum 2mb, format
                                        jpg/jpeg/png</label>
