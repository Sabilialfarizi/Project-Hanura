                ...
                <tbody>
                        ...
                        <tr style="font-size:12px;">
                           ...
                           <td>  @php
                                ...
                                {{ $kec->name  ??'-' }} </td>
                            <td>   
                            <div class="d-flex justify-content-center">  <a  data-toggle="tooltip" data-placement="top" title="Cetak KTA Anggota"href="/dpp/kabupaten/cetak/{{$data->userid}}"  class="btn btn-sm btn-secondary"><i class="fa-solid fa-print"></i></a>
                                    </div>
                            </td>
    ...
    $('.report').DataTable({
        "dom": "<'row' <'col-sm-12' l>>" + "<'row'<'col-sm-6'B><'col-sm-6'f>>" +
                ...
                buttons: [{
                    ...
                    //          window.open('/dpp/provinsi/export_parpol/{{ $detail->id_kab }}', "_blank")
                    ...
                    //   action: function ( e, dt, button, config ) {
                    //       window.open('/dpp/provinsi/export_hp_parpol/{{ $detail->id_kab }}', "_blank")
