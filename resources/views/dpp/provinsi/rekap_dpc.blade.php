                            ...
                            <tr style="font-size:13px;">
                                ...
                                <td>
                                    <a style="color:#D6A62C; font-weight:bold;"
                                        href="{{ route('dpp.rekap.pac.type', ['id' => $data->id_kab, 'type' => 0]) }}">{{ $data->jml_kab - $data->jml }}</a>
                                </td>
                                <td>
                                    <a style="color:#D6A62C; font-weight:bold;"
                                        href="{{ route('dpp.rekap.pac.type', ['id' => $data->id_kab, 'type' => 1]) }}">{{ is_null($data->jml) ? 0 : $data->jml }}</a>
                                </td>
                                <td>
                                    <a style="color:#D6A62C; font-weight:bold;"
                                        href="{{ route('dpp.rekap.pac', $data->id_kab) }}">{{ $data->jml_kab }}</a>
                                </td>
                                <td>
