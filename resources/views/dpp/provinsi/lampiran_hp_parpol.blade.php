                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body" style="border:solid; width:110%; text-align:center;"> LAMPIRAN 1 MODEL F2.HP-PARPOL</div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="margin-bottom:-8px;"><span style="font-size: 15px; font-weight:bold;">REKAPITULASI
                                    JUMLAH ANGGOTA PARTAI POLITIK HASIL PERBAIKAN</span>
                            </p>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <td style="text-align:center;">
                                   {{ \App\DetailUsers::join('users','detail_users.userid','=','users.id')
                                ...
                                <table >
                                    <thead>
                                        <tr>
                                            ...
                                            <p><span
                                                    style="font-size: 13px; font-weight:bold;">Jakarta,
