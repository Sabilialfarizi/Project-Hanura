...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a  style="background-color:#D6A62C; color:#FFFF;" class="btn float-right" href="{{ route('dpp.settings.kepengurusan.create') }}">
    ...
    $(document).ready(function () {
        ...
        function load_data(from = '', to = '') {
            ...
            var table = $('#anggota').DataTable({
                ...
                ajax: {
                    url: '/dpp/ajax/ajax_kepengurusan',
                    get: 'get',
                    data: {
                        from: from,
                        to: to,
