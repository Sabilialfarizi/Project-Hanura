...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('dpp.settings.kepengurusan.update', $kepengurusan->id_kepengurusan) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="row">
                    ...
                    <!--</div>-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="kta" class="form-control" id="kta" value="{{ $kepengurusan->kta ?? '' }}" required>
                                @if($errors->has('kta'))
                                <strong class="text-danger">
                                    {{ $errors->first('kta') }}
                                </strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="nik" class="form-control" id="nik" value="{{ $kepengurusan->nik ?? '' }}" required>
                                @if($errors->has('nik'))
                                <strong class="text-danger">
                                    {{ $errors->first('nik') }}
                                </strong>
