...
<div class="row">
    <div class="col-md-4">
        <h4 class="page-title">Kantor DPD Provinsi {{ $daerah->name }}</h4>
    </div>
            ...
            <div class="card-header">
             ...
             <div class="card-body">
                <div class="table-responsive">
                    <table class="report table table-bordered table-striped table-hover datatable" id="provinsi"
                        width="100%">
                        <thead>
                        ...
                        <tbody>
                            @if ($kantor !== null)
                             <tr style="font-size:12px;">
                                ...
                                <td>
                                    ...
                                    <a  class="btn btn-sm" style="font-size:12px; background-color:#D6A62C; color:#FFFF;"style="font-size:12px;"
                                ...
                                <td>
                                    <a style="background-color:#D6A62C; color:#FFFF;"
                                        href="{{ "/dpp/provinsi/$daerah->id_prov/kantor/$kantor->id_kantor/edit" }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a style="background-color:#D6A62C; color:#FFFF;"
                                        href="{{ "/dpp/provinsi/$daerah->id_prov/kantor/create" }}"
