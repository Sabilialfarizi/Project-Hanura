...
<div class="row">
    <div class="col-md-6">
        <h4 class="page-title">Edit Kantor DPD Provinsi {{ $daerah->name }}</h4>
    </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body pl-4">
                <form method="post"  enctype="multipart/form-data" action="{{ "/dpp/provinsi/$daerah->id_prov/kantor/$kantor->id_kantor" }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-10">
                            <input type="text" name="no_telp" class="form-control" id="no_telp" placeholder="Nomor Telepon" value="{{ $kantor->no_telp }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-10">
                            <input type="text" name="fax" class="form-control" id="fax" placeholder="Nomor Fax" value="{{ $kantor->fax }}">
                            @if($errors->has('fax'))
                                <strong class="text-danger">
                                    {{ $errors->first('fax') }}
                                </strong>
