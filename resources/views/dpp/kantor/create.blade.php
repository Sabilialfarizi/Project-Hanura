...
<div class="row">
    <div class="col-md-6">
        <h4 class="page-title">Tambah Kantor DPD Provinsi {{ $daerah->name }}</h4>
    </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body pl-4">
                <form method="post"  action="{{ "/dpp/provinsi/$daerah->id/kantor" }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_daerah" value="{{ $daerah->id_prov }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-10">
                            <input type="number" name="no_telp" value="{{ old('no_telp') }}" class="form-control"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-10">
                            <input type="number" name="fax" value="{{ old('fax') }}" class="form-control" id="fax"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-10">
                            <input type="hidden" name="is_active" value="1" class="form-control" id="is_active"
