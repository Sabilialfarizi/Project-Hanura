...
<div class="row">
    <div class="col-md-6">
        <h4 class="page-title">Edit Kantor PAC Kecamatan {{ $daerah->name }}</h4>
    </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body pl-4">
                <form method="post" enctype="multipart/form-data" action="{{ "/dpp/kecamatan/$daerah->id_kec/kantor/$kantor->id_kantor" }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="no_telp" maxlength="15" class="form-control" id="no_telp"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="wa_kantor" maxlength="15" class="form-control" id="wa_kantor"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="fax" maxlength="10" class="form-control" id="fax"
                                placeholder="Nomor Fax" value="{{ $kantor->fax }}">
                            @if($errors->has('fax'))
                            <strong class="text-danger">
                                {{ $errors->first('fax') }}
                            </strong>
                    ...
                    <!--    <div class="col-sm-10">-->
                    <!--        <input type="text" name="is_active" class="form-control" id="is_active" placeholder="Status Kantor" value="{{ $kantor->is_active }}">-->
