...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover report">
                <thead>
                    <tr>
                        <th width="10">
                            No.
                ...
                <tbody>
                    ...
                    @foreach($data as $key => $rows)
                        <tr data-entry-id="{{ $rows->id }}">
                            ...
                            <td style="text-align:center;vertical-align: middle;">
                                {{$rows->Districts->Kabupaten->Provins->name}}
                            </td>
                            <td style="text-align:center;vertical-align: middle;">
                                {{$rows->Districts->Kabupaten->name}}
                            </td>
                            <td style="text-align:center;vertical-align: middle;">
                                {{$rows->Districts->name}}
                            </td>
                            ...
                            <td style="text-align:center;vertical-align: middle;">
                                @if($rows->status == 3)
                                    <a href="{{ route('dpp.exports.download', $rows->id) }}" title="Export KTA KTP"class="btn btn-sm"style="background-color:#D6A62C; color:#ffff; font-weight:bold;" >
