...
<div class="row">
    <div class="col-md-12">
        <h4 class="page-title">Anggota Yang Sudah Digenerated KTA dan KTP : {{ $kecamatan->name }} </h4>
    </div>
			...
			<div class="table-responsive">
				...
				<div style="margin-bottom: 10px;" class="row">
				     <div class="col-lg-12 col-md-12 col-xl-12">
                          ...
                          <form method="GET" action="/dpp/provinsi/{{$kecamatan->id_kec}}/kecamatan/{{$kecamatan->id_kec}}/generated/update">
                            ...
                            <a  href="/dpp/provinsi/{{$kecamatan->id_kab}}/kecamatan"
...
<script>
    $(document).ready(function () {
        var app = $('#import').DataTable({
            ...
            'ajax': '/dpp/ajax/{{$kecamatan->id_kec}}/ajax_generated',
            columns: [{
                    data: 'id',
                    name: 'id',
