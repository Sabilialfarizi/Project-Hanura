...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <strong>Form Edit Kecamatan</strong>
        </div>

        <div class="card-body">
            <form action="{{ "/dpp/kecamatan/$kecamatan->id" }}" method="post">
                @csrf
                @method('patch')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-10">
                                <select name="id_kab" id="id_kab" class="form-control select2" style="width: 100%; height:36px;">
                                    ...
                                    <option {{ $data == $kecamatan->id_kab ? 'selected' : '' }} value="{{ $data }}" name="{{ $row }}">{{ $row }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" name="id_kec" class="form-control" id="id_kec" value="{{ $kecamatan->id_kec ?? '0' }}" data-fixedValue={{ $kecamatan->id_kab }} required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" class="form-control" id="name" value="{{ $kecamatan->name ?? '' }}" required>
                                @if($errors->has('name'))
                                <strong class="text-danger">
                                    {{ $errors->first('name') }}
                                </strong>
