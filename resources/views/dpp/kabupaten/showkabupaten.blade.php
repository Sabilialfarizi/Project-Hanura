                        ...
                        <tr style="font-size:12px;">
                           ...
                           <td>  @php
                                ...
                                {{ $kec->name ??'-' }} </td>
                                  ...
                                  <a  data-toggle="tooltip" data-placement="top" title="Cetak KTA Anggota" href="/dpc/member/{{$data->id}}/cetak"  class="btn btn-sm btn-secondary"><i class="fa-solid fa-print"></i></a>
                                    </div>
                            </td>
