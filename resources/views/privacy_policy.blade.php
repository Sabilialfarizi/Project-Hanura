...
<body>
    ...
    <p>
        Hanura Party built the Hanura mobile app as
        a Free app. This SERVICE is provided by
        Hanura Party at no cost and is intended for use as
        is.
    </p>
    <p>
    ...
    <p>
        ...
        Hanura mobile unless otherwise defined in this Privacy Policy.
    </p>
    <p><strong>Information Collection and Use</strong></p>
    <p>
        For a better experience, while using our Service, we
        may require you to provide us with certain personally
        identifiable information, including but not limited to Hanura mobile. The information that
    ...
    <p>
        ...
        Privacy Policy, do not hesitate to contact us at info@hanura.net.
    </p>
