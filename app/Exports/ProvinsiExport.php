...
use App\{Kabupaten, DetailUsers, User};
...
class ProvinsiExport extends DefaultValueBinder implements WithCustomValueBinder, FromView
{
    ...
    * @return \Illuminate\Support\Collection
    ...
    {
          $detail =  User::join('detail_users', 'users.id', '=', 'detail_users.userid')
                    ...
                    ->select('detail_users.no_member','detail_users.created_by as pegawai','detail_users.kabupaten_domisili','detail_users.nickname','detail_users.nik','jenis_kelamin.name as gender',
                          'detail_users.birth_place','detail_users.tgl_lahir','status_pernikahans.nama','jobs.name','detail_users.alamat','detail_users.status_kta','detail_users.kabupaten_domisili','detail_users.kecamatan_domisili','detail_users.kelurahan_domisili')
                     ->where('detail_users.provinsi_domisili', $this->id)
        ...
        return view('dpd.member.provinsi', [
            'details' =>$detail
        ]);
    }
