...
class DPCExport_hp extends DefaultValueBinder implements WithCustomValueBinder, FromView
{
    ...
    * @return \Illuminate\Support\Collection
     ...
     public function view(): View
    {
        ...
        'detail_users.birth_place','detail_users.tgl_lahir','status_pernikahans.nama','jobs.name','detail_users.alamat','detail_users.kelurahan_domisili','kelurahans.id_kpu')
        ->get();
