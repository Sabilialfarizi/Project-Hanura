...
use App\{Kabupaten,Kecamatan, DetailUsers};
...
class KecamatanExport extends DefaultValueBinder implements WithCustomValueBinder, FromView
{
    ...
    protected $kabupaten;
    protected $id;
    public function __construct(Kecamatan $kecamatan, $id)
    {
