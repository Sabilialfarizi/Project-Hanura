...
use App\{Kepengurusan, Kabupaten, Kecamatan, Jabatan, DetailUsers, User};


class KepengurusanKabupatenController extends Controller
{
    /**
    ...
    public function index($id_daerah)
    {
        ...
        $kabupaten = Kabupaten::where('id_kab', $id_daerah)->first();

        return view('dpd.kepengurusan.index', compact('kepengurusan', 'kabupaten'));
    }
    ...
    public function create($id_daerah)
    {
        ...
        return view('dpd.kepengurusan.create', compact('jabatan', 'kabupaten'));
    }
      public function loaddata(Request $request, $id_daerah)
    {
        ...
        $pembatalan =  User::join('model_has_roles','users.id','=','model_has_roles.model_id')
            ...
            // ->where('detail_users.kabupaten_domisili', $id_daerah)
    ...
    public function store(Request $request, $id_daerah)
    {
       ...
       $peng = Kepengurusan::insert($kepengurusan);
        ...
        return redirect("/dpd/kabupaten/$id_daerah/kepengurusan")->with('success','Data berhasil diupdate');
    }
    ...
    public function edit($id_daerah, $id)
    {
        ...
        return view('dpd.kepengurusan.edit', compact('kepengurusan', 'jabatan', 'kabupaten'));
    }
    ...
    public function destroy($id_daerah, $id)
    {
        ...
        return redirect("/dpd/kabupaten/$id_daerah/kepengurusan/")->with('success','Data berhasil dihapus');
    }
}