...
class ArticleCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dpd.kategori.index', compact('category'));
    }
    ...
    public function create()
    {
        ...
        return view('dpd.kategori.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dpd.kategori.index')->with('success', 'Kategori Informasi Sudah di Create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dpd.kategori.edit', compact('category'));
    }
