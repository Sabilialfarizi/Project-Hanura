...
class InformationController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($program);
        return view('dpd.informasi.index', compact('info'));
    }
    ...
    public function create()
    {
        ...
        return view('dpd.informasi.create', compact('category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dpd.informasi.index')->with('success', 'Informasi Sudah di Create');
    }
    ...
    public function show($id)
    {
        ...
        return view('dpd.informasi.show', compact('info'));
    }
    ...
    public function edit($id)
    {
        ...
        $category = Category::where('is_active', 1)->pluck('name', 'id');
        return view('dpd.informasi.edit', compact('informasi','category'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('dpd.informasi.index')->with('success', 'Informasi Sudah di Update');
    }
    ...
    public function destroy($id)
    {
       ...
       return redirect()->route('dpd.informasi.index')->with('success', 'Informasi Sudah di Delete');
    }
}