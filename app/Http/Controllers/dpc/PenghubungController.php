...
use App\{Kepengurusan, Kabupaten, Provinsi, Jabatan, DetailUsers, User, Penghubung};
...
class PenghubungController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dpc.penghubung.index', compact('DetailUsers'));
    }
    public function getindex()
    {
        ...
        return view('dpc.penghubung.index_2', compact('DetailUsers'));
    }
    ...
    public function create()
    {
        ...
        return view('dpc.penghubung.create', compact('jabatan', 'kabupaten', 'detail'));
    }
    ...
    public function store(Request $request)
    {
        ...
        [
         ...
         $filename=time().'_' . $request->kabupaten_domisili .'_' . $uploadedFile->getClientOriginalName();
        ...
        $penghubung = Penghubung::insert($peng);

        return redirect("/dpc/penghubung")->with('success','Data berhasil ditambah');
    }
    ...
    public function edit($id)
    {
        ...
        $penghubung = Penghubung::join('detail_users', 'petugas_penghubung.koordinator', '=', 'detail_users.id')
            ->select('detail_users.nickname','petugas_penghubung.kabupaten_domisili','detail_users.nik',  'detail_users.id', 'petugas_penghubung.no_sk', 'petugas_penghubung.no_telp', 'petugas_penghubung.jabatan', 'petugas_penghubung.id', 'petugas_penghubung.email', 'petugas_penghubung.alamat', 'petugas_penghubung.koordinator', 'petugas_penghubung.tanggal_sk', 'petugas_penghubung.name', 'petugas_penghubung.attachment')
            ->where('petugas_penghubung.id', $id)->first();
        return view('dpc.penghubung.edit',[
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('attachment') == '') {
         ...
         $filename=time().'_'. $request->kabupaten . '_' . $uploadedFile->getClientOriginalName();
         $uploadedFile->move('uploads/file/petugas_penghubung/', $filename);
       }
        ...
        return redirect("/dpc/penghubung/")->with('success','Data berhasil diupdate');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect("/dpc/penghubung/")->with('success','Data berhasil dihapus');
    }
}
