...
class GeneratedController extends Controller
{
     ...
     */
    public function index($id_kec, $id)
    {
        ...
        return view('dpp.kecamatan.generate_kta',compact('kecamatan'));
    }
    ...
    public function show(Request $request)
    {
        ...
        $message = 'succes';
         return redirect('/dpp/provinsi/'.$kecamatan->kabupaten_domisili.'/kecamatan/'.$kecamatan->kecamatan_domisili.'/generated')->with('message', 'sukses');;
    }
